...
<img class="sm:float-right sm:ml-8 sm:-mt-10 object-contain w-100 h-80 sm:h-100" alt="Portait of Steve" src="{portrait}">
...
<img class="sm:float-left sm:mr-8 sm:-mt-10 object-contain w-100 h-80 sm:h-100" alt="Close up of Steve sharpening a knife" src="{closeup}">
